...
import tw.elliot.domain.support.AndCondition;
import tw.elliot.domain.support.BetweenCondition;
import tw.elliot.domain.support.Condition;
import tw.elliot.domain.support.ContainsCondition;
import tw.elliot.domain.support.InCondition;
import tw.elliot.domain.support.LikeCondition;
import tw.elliot.domain.support.NotNullCondition;
import tw.elliot.domain.support.NullCondition;
import tw.elliot.domain.support.OrCondition;
import tw.elliot.domain.support.SimpleCondition;
